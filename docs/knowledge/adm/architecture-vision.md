...
**Judgment & trade-offs:** when scoping the Statement of Architecture Work:

| Question | Lean towards … when | Lean away when |
|---|---|---|
| **Broad scope vs. narrow** | Strategic transformation; budget supports it | Tactical change; risk of paralysis |
| **Many stakeholder concerns vs. focused** | Multi-domain change | Single capability |
| **Long horizon vs. short** | Foundational rebuild | Incremental improvement |

**Synthesis exercise:** take an in-flight engagement. Try to answer in 60 seconds: *what is the vision, who is the sponsor, and what are the top three risks?* If you can't, the Statement of Architecture Work is missing or stale.
