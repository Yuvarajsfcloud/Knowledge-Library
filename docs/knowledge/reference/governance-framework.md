...
**Quick recall:** four operational artefacts — *Architecture Contract* (the standard), *Compliance Review* (the check), *Dispensation* (governed deviation), *Architecture Board* (the deciding body). Without all four, governance is theatre.
