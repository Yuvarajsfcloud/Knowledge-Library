...
!!! info "Companion visual page"
    A higher-level, filterable visual pattern catalogue is published as a static HTML page alongside the documentation site:
...
- [Architecture Notes](../architecture-notes/index.md) — deeper essays on selected patterns
