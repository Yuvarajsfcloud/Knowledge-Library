...
**Quick recall:** *ABB* answers "what capability is required?" *SBB* answers "which product delivers it?" One ABB may be realised by multiple competing SBBs. ADRs record which SBB was chosen and why.
...
| **Message Broker** | Async event and message routing | AWS SQS/SNS, Kafka, RabbitMQ, Azure Service Bus | See [ADR-002](../decision-records/ADR-002-async-events.md) |
...
See [Technology Evaluation Playbook](../../playbook/operational/technology-evaluation.md) for the full evaluation process.
