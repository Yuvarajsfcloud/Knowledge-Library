...
**Quick recall:** *Viewpoint* = the camera angle specification (what to show, for whom, in what notation). *View* = the actual photograph taken from that angle. Always design viewpoints first, then produce views.
...
Use: [C4 Context Diagram — see Engagement Phase 2 Design](../../playbook/engagement/02-design.md)
...
Use: [Phase E–F — Migration Planning](../adm/migration-planning.md)
