...
**Quick recall:** four bands — *Foundation* (industry-generic), *Common Systems* (cross-industry but typed), *Industry* (regulated/sector-specific), *Organisation-Specific* (unique to this enterprise). Re-use moves left-to-right; differentiation lives on the right.
