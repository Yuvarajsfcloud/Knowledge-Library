...
See [Phase D — Technology Architecture](phase-d-technology.md) for the full Technology Standards Catalogue.
...
From the [Preliminary Phase](preliminary.md). Principles are maintained here as the canonical record.
...
All governance decisions are recorded here. See also [Architecture Governance](../governance/index.md).

| Record Type | Location | Format |
|---|---|---|
| Architecture Decision Records | `docs/adrs/` | Markdown ADR (see [ADR index](../adrs/index.md)) |
